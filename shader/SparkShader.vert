...
uniform mat4 model;
uniform mat4 rot;
uniform vec4 particle_position;
uniform vec4 particle_old_position;
uniform float size;
uniform vec4 color;
...
void main()
{
	...
	vertex2 = rot * vertex2;
	if(vertex.z == -1.0)
		vertex2 = vertex2 + particle_old_position;
	else
		vertex2 = vertex2 + particle_position;
    
    // transform vertex to world-space
    world_position = model * vertex2;
    ...
    gl_Position = perspective * view * model * vertex2;
}
