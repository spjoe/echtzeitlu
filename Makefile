...
SRC = src/ogl3_test.o src/shader.o src/utility.o src/camera.o src/ModelLoader.o src/SceneObject.o src/Model.o src/Effect.o src/Timer.o src/ModelObject.o src/ModelImage.o src/ModelEffect.o src/ModelMaterial.o src/Particle.o src/ParticleSystem.o src/ParticleManager.o
